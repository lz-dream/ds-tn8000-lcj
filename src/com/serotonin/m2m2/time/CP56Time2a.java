package com.serotonin.m2m2.time;
...
public class CP56Time2a {
	 ...
	 */
	public CP56Time2a(long timestamp, TimeZone timeZone, boolean invalid) {
	...
	/**
	 * Creates a valid Time56 instance using the given timestamp and the default
	 * time zone.
	 * 
	 * @param timestamp
	 *                  the timestamp that shall be used to calculate Time56
	 */
	public CP56Time2a(long timestamp) {
		this(timestamp, TimeZone.getDefault(), false);
	}

	public CP56Time2a(byte[] value) {
		for (int i = 0; i < 7; i++) {
			this.value[i] = value[i];
		}
	}

	CP56Time2a(DataInputStream is) throws IOException {
		is.readFully(value);
	}
	 ...
	 * 
	 * Note that Time56 does not store the century of the date. Therefore you have
	 * to pass the earliest possible year of the Time56 instance. Say the year
	 * stored by Time56 is 10. From this information alone it is not possible to
	 * tell whether the real year is 1910 or 2010 or 2110. If you pass 1970 as the
	 * start of century, then this function will know that the year of the given
	 * date lies between 1970 and 2069 and can therefore calculate that the correct
	 * date is 2010.
	 * 
	...
	/**
	 * Returns the timestamp in ms equivalent to this Time56 instance. The default
	 * time zone is used.
	 * 
	 * Note that Time56 does not store the century of the date. Therefore you have
	 * to pass the earliest possible year of the Time56 instance. Say the year
	...
	public long getTimestamp(int startOfCentury) {
		return getTimestamp(startOfCentury,  TimeZone.getTimeZone("Asia/Shanghai"));
	}

	public long get21CenturyTimestamp() {
		return getTimestamp(2017);
	}

	/**
	 * Returns the timestamp in ms equivalent to this Time56 instance. Assumes that
	 * the given date is between 1970 and 2070. The default time zone is used.
	 * 
	 * @return the timestamp in ms equivalent to this Time56 instance
	 */
	...
	/**
	 * Returns the millisecond of the second. Returned values can range from 0 to
	 * 999.
	 * 
	...
	/**
	 * Returns the day of the week. Returned values can range from 1 (Monday) to 7
	 * (Sunday).
	 * 
	...
	/**
	 * Returns the month of the year. Returned values can range from 1 (January) to
	 * 12 (December).
	 * 
	...
	/**
	 * Returns the year in the century. Returned values can range from 0 to 99. Note
	 * that the century is not stored by Time56.
	 * 
