...
<div>
  <table>
    ...
    <tbody id="textRendererB64DSize" style="display:none;">
    </tbody>
...
<script type="text/javascript">
  ...
  function textRendererChanged(name,oldValue,value){
      if (value == "textRendererAnalog"){
          ...
          hide("binaryValuesRow");
      }else if (value == "textRendererNone" || value == "textRendererB64DSize"){
    	  hide("datetimeFormatHelpDiv");
          hide("suffixRow");
          hide("formatRow");
          hide("rangeValuesRow");
      ...
      DataPointDwr.getTextRendererOptions(vo.pointLocator.dataTypeId,function (response){
        ...
        if(vo.textRenderer != null){
            ...
            if (vo.textRenderer.typeName == "textRendererAnalog"){
          	  ...
          	  //Nothing
            }else if (vo.textRenderer.typeName == "textRendererB64DSize"){
          	  //Nothing
  ...
  function getTextRenderer(vo){
       ...
       }else if (typeName == "textRendererB64DSize"){
           vo.textRenderer = new Base64DecodeSizeRenderer();
  ...
  function resetTextRendererOptions(dataTypeId){
          ...
          switch(dataTypeId){
          	case <%= DataTypes.ALPHANUMERIC %>:
          		vo.textRenderer.typeName = "textRendererB64DSize";
