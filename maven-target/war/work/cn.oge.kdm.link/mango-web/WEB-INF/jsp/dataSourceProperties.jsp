...
--%>
<c:set var="dwrClasses">DataSourceEditDwr,DataSourceDwr,DataPointDwr,DataPointEditDwr,KdmKksDwr</c:set>
<%-- [OGE][#][20170404][END] --%>
...
<c:forEach items="<%= Common.moduleScripts %>" var="modScript">
  ...
  <%-- [OGE][+][20170404][BEGIN] --%>
  <script type="text/javascript" src="/resources/dataSourcePropertiesKdm.js"></script>
  <link rel="stylesheet" type="text/css" href="/resources/dataSourcePropertiesKdm.css"/>
  <%-- [OGE][+][20170404][END] --%>
